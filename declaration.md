...
If you have an issue with this statement please contact us by email: **info@codex.gq**.
...
This bright piece of code appeared courtesy to Yury Matuhin `(https://github.com/ymatuhin)`. First appeared at his personal blog `(https://ymatuhin.ru/front-end/html5-link-prefetch/)`
Based on Resource Hints W3C Working Draft 05 October 2020 `(https://www.w3.org/TR/resource-hints/)`, Link prefetching FAQ of MDN Web Docs `(https://developer.mozilla.org/en-US/docs/Web/HTTP/Link_prefetching_FAQ)` and Eliminating Roundtrips with Preconnect `(https://www.igvita.com/2015/08/17/eliminating-roundtrips-with-preconnect/)`
...
The main background image is inherit from the Creative theme by Start Bootstrap. All other images are taken from the Internet search. For copyright issues please contact us by email: **info@codex.gq**. We will be happy to make credentials for authors.

#### Image Tools

We used a plenty of online tools and apps for image creation, optimization and convertion such as:
...
...and this list is not exhaustive for sure.
...
**codexgq - Moving The Web `(https://codex.gq/)`**
